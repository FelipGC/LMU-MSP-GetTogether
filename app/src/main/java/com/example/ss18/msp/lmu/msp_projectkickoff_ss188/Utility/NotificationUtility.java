...
public class NotificationUtility {
    ...
    public static void displayNotification(final String title, final String message, final int priority) {
        ...
        NotificationCompat.Builder mBuilder = new NotificationCompat.Builder(AppLogicActivity.getInstance(), CHANNEL_ID)
        ...
        mBuilder.build();
        NotificationManager mNotificationManager = (NotificationManager) AppLogicActivity.getInstance().getSystemService(Context.NOTIFICATION_SERVICE);
    ...
    public static void startVibration(){
        ...
        Vibrator v = (Vibrator) AppLogicActivity.getInstance().getSystemService(Context.VIBRATOR_SERVICE);
